...
pkgdatadir = $(datadir)/ntp4
pkgincludedir = $(includedir)/ntp4
pkglibdir = $(libdir)/ntp4
pkglibexecdir = $(libexecdir)/ntp4
...
ACLOCAL = ${SHELL} /ntp_dev/sntp/libevent/build-aux/missing --run aclocal-1.11
ALLOCA = 
AMTAR = ${SHELL} /ntp_dev/sntp/libevent/build-aux/missing --run tar
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /ntp_dev/sntp/libevent/build-aux/missing --run autoconf
AUTOHEADER = ${SHELL} /ntp_dev/sntp/libevent/build-aux/missing --run autoheader
AUTOMAKE = ${SHELL} /ntp_dev/sntp/libevent/build-aux/missing --run automake-1.11
AWK = mawk
...
LSCF = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /ntp_dev/sntp/libevent/build-aux/missing --run makeinfo
MAKE_ADJTIMED = 
...
PACKAGE_NAME = ntp4
PACKAGE_STRING = ntp4 4.2.7p475
PACKAGE_TARNAME = ntp4
PACKAGE_URL = http://www.ntp.org./
PACKAGE_VERSION = 4.2.7p475
PATH_NET_SNMP_CONFIG = 
PATH_PERL = /usr/bin/perl
PATH_SEPARATOR = :
PATH_TEST = /usr/bin/test
PERLLIBDIR = /usr/local/share/ntp/lib
PKG_CONFIG = 
POSIX_SHELL = /bin/bash
PROPDELAY = propdelay
PTHREAD_LIBS =  -pthread -Wl,--no-as-needed,-lgcc_s,--as-needed
RANLIB = ranlib
SED = /bin/sed
SET_MAKE = 
SHELL = /bin/bash
...
YACC = yacc
YFLAGS = 
abs_builddir = /ntp_dev
abs_srcdir = /ntp_dev
abs_top_builddir = /ntp_dev
abs_top_srcdir = /ntp_dev
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /ntp_dev/sntp/libevent/build-aux/install-sh
